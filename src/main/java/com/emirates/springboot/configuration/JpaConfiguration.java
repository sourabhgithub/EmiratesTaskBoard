package com.emirates.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.emirates.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.emirates.springboot.model" });
